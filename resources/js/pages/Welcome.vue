...
const props = defineProps({
  filePath: String // something like 'uploads/filename.jpg'
})
</script>
...
<Link
    ...
    :href="`${user.name === 'cashier' ? user.name + '/inventory' : user.name + '/dashboard'}`"
    class="inline-block rounded-sm border border-[#19140035] px-5 py-1.5 text-sm leading-normal text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
>
    {{ user.name === 'cashier' ? 'Inventory' : 'Dashboard' }}
</Link>
        ...
        <div class="duration-750 starting:opacity-0 flex w-full items-center justify-center opacity-100 transition-opacity lg:grow">
            <main class="flex w-full max-w-[335px] flex-col-reverse overflow-hidden rounded-lg lg:max-w-4xl lg:flex-row">
                ...
                >
                    <h1 class="mb-1 font-medium">King Of Pares Stock Management System</h1>
                    <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                        HARI SA LASA, HARI SA SARAP!
                    </p>
                    <ul class="mb-4 flex flex-col lg:mb-6">
                        ...
                        >
                            ...
                            <span>
                                View our 
                                <a
                                    href="https://utak.io/store/KING OF PARES"
                                    target="_blank"
                        ...
                        >
                            ...
                            <span>
                                See our
                                <a
                                    href="https://www.facebook.com/kingofthepares"
                                    target="_blank"
                                    class="ml-1 inline-flex items-center space-x-1 font-medium text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                                    <span>Facebook</span>
                ...
                >
  <img src="http://192.168.2.185:8000/storage/welcome/kingofpares.png" alt="Uploaded Image" />
